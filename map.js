//These are all of the responses per each individual submission, well done!
// api key to access JotForm, switch my key for yours
JF.initialize({apiKey:"7d96bf63d8e555a61176719a8d18e4ff"}); //PUT YOUR OWN KEY HERE

// get form submissions from JotForm Format: (formID, callback)
JF.getFormSubmissions("223123858275055", function(response) {
